...
##    if len(str(result)) <= 20: screen.insert(0, result)
##    else:        
##        try: screen.insert(0, '%e'%float(result))            
##        #περιπτώσεις σύνθετων υπολογισμών με μεγάλους αριθμούς
...
def main():    
    ...
    #τίτλος
    start_window.title("[ΠΛΗΠΡΟ - ΗΛΕ52] 2023 - 2024 Ομάδα_5_Project    Smart Calc v.2.0.4")
